...
namespace AppsTracker
{
    ...
    public class ConvertSelectedIndexToBool : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
    ...
    public class ConvertTicksToTimespan : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
    ...
    public class ConvertDoubleToTimespan : IValueConverter
    {
    ...
    public class ConvertAppLimitsToBool : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            if (value == null)
    ...
    public class ConvertAppLimitToTimeSpan : IValueConverter
    {
    ...
    public class ConvertLimitSpanToMaxSlider : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
    ...
    public class ConvertTopWindowDuration : IValueConverter
    {
    ...
    public class ConvertDateRangeToString : IMultiValueConverter
    {
    ...
    public class ConvertIdleTimer : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
    ...
    public class ConvertTrialStartDate : IValueConverter
    {
    ...
    public class MultiControlHasErrorsToBoolConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            foreach (var value in values)
